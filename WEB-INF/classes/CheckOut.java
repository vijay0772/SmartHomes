	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		try {
			...
			for (OrderItem oi : utility.getCustomerOrders()) {
				...
				pw.print("<input type='hidden' name='hasWarranty' value='"+oi.isWarrantyIncluded()+"'>");
			...
			pw.print("<table class='gridtable'><tr></tr><tr></tr>");
			...
			pw.print("<td><select name='deliveryMethod'>");
			pw.print("<option value='Home Delivery'>Home Delivery</option>");
			pw.print("<option value='In Store Pickup'> In Store Pickup</option>");
			pw.print("</td></tr>");
			...
			pw.print("<input type='hidden' name='hasWarranty' value='No'>");
